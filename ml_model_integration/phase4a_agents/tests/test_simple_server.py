...
class TestSimpleConservationServer:
    """Simple test class with clear test methods."""
    ...
    @pytest.mark.asyncio
    async def test_server_health_check(self, server_setup):
    ...
    @pytest.mark.asyncio
    async def test_store_conservation_event(self, server_setup):
    ...
    @pytest.mark.asyncio
    async def test_retrieve_site_events(self, server_setup):
    ...
    @pytest.mark.asyncio
    async def test_conservation_statistics(self, server_setup):
...
class TestServerPerformance:
    ...
    @pytest.mark.asyncio
    async def test_response_time(self, server_setup):
    ...
    @pytest.mark.asyncio
    async def test_multiple_requests(self, server_setup):
